...
static const CGFloat CSToastHorizontalImage_TitleSpace   = 10.0;

static const CGFloat CSToastVerticalPadding     = 10.0;
static const CGFloat CSToastCornerRadius        = 18.0;
...
// image view size
static const CGFloat CSToastImageViewWidth      = 15.0;
static const CGFloat CSToastImageViewHeight     = 15.0;
...
- (void)makeToast:(NSString *)message duration:(NSTimeInterval)duration position:(id)position image:(UIImage *)image {
    [self makeToast:message duration:duration position:position image:image animated:NO];
}
...
- (CGPoint)centerPointForPosition:(id)point withToast:(UIView *)toast {
    if([point isKindOfClass:[NSString class]]) {
        if([point caseInsensitiveCompare:CSToastPositionTop] == NSOrderedSame) {
            ...
            return CGPointMake(self.bounds.size.width / 2, (self.bounds.size.height - 330));
...
//    wrapperView.backgroundColor = [[UIColor blackColor] colorWithAlphaComponent:CSToastOpacity];
    ...
    if(titleLabel != nil) {
        ...
        if (imageView) {
            titleLeft = imageLeft + imageWidth + CSToastHorizontalImage_TitleSpace;
        } else {
    ...
    if(messageLabel != nil) {
        ...
        if (imageView) {
            messageLeft = imageLeft + imageWidth + CSToastHorizontalImage_TitleSpace;
        } else {
    ...
    if(titleLabel != nil) {
        ...
        if (messageLabel == nil) {
            titleLabel.center = CGPointMake(titleLabel.center.x, wrapperView.bounds.size.height/2);
        }
    ...
    if(imageView != nil) {
        ...
        imageView.center = CGPointMake(imageView.center.x, wrapperView.bounds.size.height/2);
